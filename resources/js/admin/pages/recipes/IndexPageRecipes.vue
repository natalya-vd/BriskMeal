            ...
            <div class="card border-0 ">
                <div class="card-body">
                    <div class="d-flex justify-content-end mb-3">
                        <a class="btn btn-outline-primary" href="/admin/recipes/create">
                            Add recipe
                        </a>
                    </div>
                            ...
                            <tbody>
                                ...
                                <td class="align-middle">
                                    <div class="cell-action">
                                        <a :href="`/admin/recipes/${item.id}/edit`" class="btn-action btn btn-primary">
...
import {deleteRecipe, getListRecipes} from '../../api/api.js'
    ...
    methods: {
        ...
        async onDelete(id) {
            try {
                ...
                const dataResponse = await getListRecipes()
