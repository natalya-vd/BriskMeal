...
export default {
    ...
    computed: {
        ...
        getPathCreate() {
            return `${routes.nutritionValue.index}/create`
        }
    },
    ...
    methods: {
        async onDelete(id) {
            try {
                ...
                if(result) {
                    ...
                    // const dataResponse = await getListResource(ADMIN_NUTRITION_VALUES)
        ...
        getPathEdit(id) {
            return `${routes.nutritionValue.index}/${id}/edit`
        }
    },
}
</script>
