<template>
    <div class="sideBar" v-if="this.visiblilitySideBar">
        <section class="sideBarSection">
            ...
            <div class="sideBarRegistration">
                <a class="sideBarSignup" href="/plans"><span>Sign up</span></a>
                <a class="sideBarLogin" href="/plans"><span>Log In</span></a>
            </div>
            ...
            <div class="sideBarNavigation">
                <a class="navigationLink" href="/catalog"
                    ><span class="navigationText">FAQs</span></a
                >
                <a class="navigationLink" href="/catalog"
                    ><span class="navigationText">Conact Us</span></a
                >
                <a class="navigationLink" href="/catalog"
